    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 flex items-start justify-center h-screen pt-24 px-4">
                <div className="w-full max-w-md bg-black/70 backdrop-blur-xl border border-white/10
                    rounded-xl shadow-xl p-8 text-white animate-slide-up">

                    <h2 className="text-center text-2xl font-semibold mb-5">Log In</h2>
                    ...
                    <p className="text-center text-sm mt-5">
                        ...
                        <Link href={route("register")} className="text-yellow-400 hover:text-yellow-300 hover:underline">
                            Register
                        </Link>
                    </p>
                </div>
