                                ...
                                <section className="space-y-6 max-w-3xl">
                                    <header>
                                        ...
                                        <p className="mt-1 text-sm text-white/70">
                                            ...
                                            and data will be permanently deleted. Before deleting
                                            your account, please download any data or information
                                            ...
                                            <div className="mt-6">
                                                ...
                                                <div className="relative">
                                                    <TextInput
                                                        ...
                                                        className="mt-1 block w-3/4 pr-12"
                                                        isFocused
